 ...
 */
namespace ATF\Review\Preference\Magento\Review\Controller\Product;
...
class Post extends ProductController implements HttpPostActionInterface
{
    ...
    private function validateNicknameForDashes() {

        $request = $this->getRequest();
        $nickname = $request->getParam('nickname');

        if (strstr(trim($nickname, '-'))) {

            $this->messageManager->addErrorMessage(
                __('Nickname must not contain dashes')
            );
